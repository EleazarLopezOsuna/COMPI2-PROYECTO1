...
def p_init(t):
    ...
    t[0] = NodoSintactico("INICIO", "INICIO", -1, -1)
    t[0].addHijo(t[1])
...
def p_listaInstrucciones_2(t):
    ...
    t[0] = NodoSintactico("INSTRUCCION", "INSTRUCCION", -1, -1)
    t[0].addHijo(t[1])

def p_instruccion_1(t):
    'instruccion    : asignacion PUNTOCOMA'
    t[1].addHijo(NodoSintactico("PUNTOCOMA", ";", t.lineno(2), find_column(input, t.slice[2])))
    t[0] = t[1]
...
def p_instruccion_11(t):
    ...
    t[0] = NodoSintactico("INSTRUCCIONBREAK", "INSTRUCCIONBREAK", -1, -1)
    t[0].addHijo(NodoSintactico("BREAK", "break", t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("PUNTOCOMA", ";", t.lineno(2), find_column(input, t.slice[2])))

def p_instruccion_12(t):
    'instruccion    : resContinue PUNTOCOMA'
    t[0] = NodoSintactico("INSTRUCCIONCONTINUE", "INSTRUCCIONCONTINUE", -1, -1)
...
def p_asignacionGlobal(t):
    ...
    t[0] = NodoSintactico("GLOBAL", "GLOBAL", -1, -1)
...
def p_asignacionLocal(t):
    ...
    t[0] = NodoSintactico("LOCAL", "LOCAL", -1, -1)
...
def p_asignacion_1(t):
    ...
    t[0] = NodoSintactico("ASIGNACION", "ASIGNACION", -1, -1)
    t[0].addHijo(NodoSintactico("IDENTIFICADOR", t[1], t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("IGUAL", "=", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])
    t[0].addHijo(NodoSintactico("DOBLEPUNTOS", "::", t.lineno(4), find_column(input, t.slice[4])))
    t[0].addHijo(t[4])
...
def p_asignacion_3(t):
    ...
    t[0].addHijo(NodoSintactico("IDENTIFICADOR", t[1], t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(t[2])
    t[0].addHijo(NodoSintactico("IGUAL", "=", t.lineno(3), find_column(input, t.slice[3])))
    t[0].addHijo(t[4])
...
def p_llamadaFuncion_1(t):
    ...
    t[0] = NodoSintactico("LLAMADAFUNCION", "LLAMADAFUNCION", -1, -1)
    t[0].addHijo(NodoSintactico("IDENTIFICADOR", t[1], t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(4), find_column(input, t.slice[4])))
...
def p_llamadaFuncion_2(t):
    ...
    t[0].addHijo(NodoSintactico("IDENTIFICADOR", t[1], t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(3), find_column(input, t.slice[3])))
...
def p_llamadaFuncion_3(t):
    ...
    t[0].addHijo(NodoSintactico("NOT", "!", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[4])
    t[0].addHijo(NodoSintactico("COMA", ",", t.lineno(5), find_column(input, t.slice[5])))
    t[0].addHijo(t[6])
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(7), find_column(input, t.slice[7])))
...
def p_struct(t):
    ...
    t[0] = NodoSintactico("STRUCT", "STRUCT", -1, -1)
    t[0].addHijo(NodoSintactico("RESSTRUCT", "struct", t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("IDENTIFICADOR", t[2], t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])
    t[0].addHijo(NodoSintactico("END", "end", t.lineno(4), find_column(input, t.slice[4])))
    t[0].addHijo(NodoSintactico("PUNTOCOMA", ";", t.lineno(5), find_column(input, t.slice[5])))
...
def p_declararFuncion_1(t):
    ...
    t[0] = NodoSintactico("DECLARARFUNCION", "DECLARARFUNCION", -1, -1)
    ...
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(3), find_column(input, t.slice[3])))
    t[0].addHijo(t[4])
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(5), find_column(input, t.slice[5])))
    t[0].addHijo(t[6])
    t[0].addHijo(NodoSintactico("END", "end", t.lineno(7), find_column(input, t.slice[7])))
    t[0].addHijo(NodoSintactico("PUNTOCOMA", ";", t.lineno(8), find_column(input, t.slice[8])))
...
def p_declararFuncion_2(t):
    ...
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(4), find_column(input, t.slice[4])))
    t[0].addHijo(t[5])
    t[0].addHijo(NodoSintactico("END", "end", t.lineno(6), find_column(input, t.slice[6])))
    t[0].addHijo(NodoSintactico("PUNTOCOMA", ";", t.lineno(7), find_column(input, t.slice[7])))

def p_instruccionIf_1(t):
    'instruccionIf  : resIf expresion listaInstrucciones resEnd PUNTOCOMA'
    t[0] = NodoSintactico("BLOQUEIF", "BLOQUEIF", -1, -1)
...
def p_instruccionIf_2(t):
    ...
    t[0].addHijo(t[2])
    t[0].addHijo(t[3])
    t[0].addHijo(NodoSintactico("ELSE", "else", t.lineno(4), find_column(input, t.slice[4])))
    t[0].addHijo(t[5])
    t[0].addHijo(NodoSintactico("END", "end", t.lineno(6), find_column(input, t.slice[6])))
    t[0].addHijo(NodoSintactico("PUNTOCOMA", ";", t.lineno(7), find_column(input, t.slice[7])))
...
def p_instruccionIf_3(t):
    ...
    t[0].addHijo(t[2])
    t[0].addHijo(t[3])
    t[4].addHijo(NodoSintactico("ELSE", "else", t.lineno(5), find_column(input, t.slice[5])))
    t[4].addHijo(t[6])
    t[4].addHijo(NodoSintactico("END", "end", t.lineno(7), find_column(input, t.slice[7])))
    t[4].addHijo(NodoSintactico("PUNTOCOMA", ";", t.lineno(8), find_column(input, t.slice[8])))
    t[0].addHijo(t[4])

def p_instruccionElseif_1(t):
    'instruccionElseif  : instruccionElseif resElseif expresion listaInstrucciones'
    nuevo = NodoSintactico("ELSEIF", "elseif", t.lineno(2), find_column(input, t.slice[2]))
    nuevo.addHijo(t[3])
    nuevo.addHijo(t[4])
    t[0].addHijo(nuevo)
    t[0] = t[0]
...
def p_instruccionFor(t):
    ...
    t[0].addHijo(NodoSintactico("IDENTIFICADOR", t[2], t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(NodoSintactico("IN", "in", t.lineno(3), find_column(input, t.slice[3])))
    t[0].addHijo(t[3])
    t[0].addHijo(t[4])
    t[0].addHijo(NodoSintactico("END", "end", t.lineno(6), find_column(input, t.slice[6])))
    t[0].addHijo(NodoSintactico("PUNTOCOMA", ";", t.lineno(7), find_column(input, t.slice[7])))
...
def p_expresion_1(t):
    ...
    t[0] = NodoSintactico("EXPRESION", "EXPRESION", -1, -1)
    t[0].addHijo(t[1])
...
def p_expresion_8(t):
    'expresion  : ENTERO'
    t[0] = NodoSintactico("EXPRESION", "EXPRESION", -1, -1)
    t[0].addHijo(NodoSintactico("ENTERO", t[1], t.lineno(1), find_column(input, t.slice[1])))

def p_expresion_9(t):
    'expresion  : CADENA'
    t[0] = NodoSintactico("EXPRESION", "EXPRESION", -1, -1)
    t[0].addHijo(NodoSintactico("CADENA", t[1], t.lineno(1), find_column(input, t.slice[1])))

def p_expresion_10(t):
    'expresion  : CARACTER'
    t[0] = NodoSintactico("EXPRESION", "EXPRESION", -1, -1)
    t[0].addHijo(NodoSintactico("CARACTER", t[1], t.lineno(1), find_column(input, t.slice[1])))

def p_expresion_11(t):
    'expresion  : FLOTANTE'
    t[0] = NodoSintactico("EXPRESION", "EXPRESION", -1, -1)
    t[0].addHijo(NodoSintactico("FLOTANTE", t[1], t.lineno(1), find_column(input, t.slice[1])))
...
def p_expresion_15(t):
    ...
    t[0].addHijo(t[2])
    t[0].addHijo(NodoSintactico("CORCHETEC", "]", t.lineno(3), find_column(input, t.slice[3])))
...
def p_expresion_20(t):
    ...
    t[0] = NodoSintactico("EXPRESION", "EXPRESION", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("DOSPUNTOS", ":", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])
...
def p_tipo_1(t):
    'tipo   : resInt64'
    t[0] = NodoSintactico("TIPO", "TIPO", -1, -1)
...
def p_accesoFS_1(t):
    ...
    t[1].addHijo(NodoSintactico("PUNTO", ".", t.lineno(2), find_column(input, t.slice[2])))
    t[1].addHijo(NodoSintactico("IDENTIFICADOR", t[3], t.lineno(3), find_column(input, t.slice[3])))
    t[0] = t[1]

def p_accesoFS_2(t):
    'accesoFS   : PUNTO IDENTIFICADOR'
    t[0] = NodoSintactico("ACCESOFS", "accesofs", -1, -1)
...
def p_listaParametros_1(t):
    ...
    t[1].addHijo(NodoSintactico("COMA", ",", t.lineno(2), find_column(input, t.slice[2])))
    t[1].addHijo(NodoSintactico("IDENTIFICADOR", t[3], t.lineno(3), find_column(input, t.slice[3])))
    t[0] = t[1]
...
def p_listaParametros_2(t):
    ...
    t[1].addHijo(NodoSintactico("COMA", ",", t.lineno(2), find_column(input, t.slice[2])))
    t[1].addHijo(NodoSintactico("IDENTIFICADOR", t[3], t.lineno(3), find_column(input, t.slice[3])))
    t[1].addHijo(NodoSintactico("DOBLEPUNTOS", "::", t.lineno(4), find_column(input, t.slice[4])))
    t[1].addHijo(t[5])
    t[0] = t[1]

def p_listaParametros_3(t):
    'listaParametros    : IDENTIFICADOR DOBLEPUNTOS tipo'
    t[0] = NodoSintactico("LISTAPARAMETROS", "LISTAPARAMETROS", -1, -1)
    t[0].addHijo(NodoSintactico("IDENTIFICADOR", t[1], t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("DOBLEPUNTOS", "::", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])
...
def p_bloqueStruct(t):
    'bloqueStruct   : bloqueStruct declaracionAtributo'
    t[1].addHijo(t[2])
    t[0] = t[1]

def p_bloqueStruct_2(t):
    'bloqueStruct   : declaracionAtributo'
    t[0] = NodoSintactico("BLOQUESTRUCT", "BLOQUESTRUCT", -1, -1)
    t[0].addHijo(t[1])

def p_declaracionAtributo_1(t):
    'declaracionAtributo    : IDENTIFICADOR DOBLEPUNTOS tipo PUNTOCOMA'
    t[0] = NodoSintactico("ATRIBUTO", "ATRIBUTO", -1, -1)
    t[0].addHijo(NodoSintactico("IDENTIFICADOR", t[1], t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("DOBLEPUNTOS", "::", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])
    t[0].addHijo(NodoSintactico("PUNTOCOMA", ";", t.lineno(4), find_column(input, t.slice[4])))

def p_declaracionAtributo_2(t):
    'declaracionAtributo    : IDENTIFICADOR PUNTOCOMA'
    t[0] = NodoSintactico("ATRIBUTO", "ATRIBUTO", -1, -1)
    t[0].addHijo(NodoSintactico("IDENTIFICADOR", t[1], t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("PUNTOCOMA", ";", t.lineno(2), find_column(input, t.slice[2])))
...
def p_dimension_1(t):
    ...
    t[1].addHijo(NodoSintactico("CORCHETEA", "[", t.lineno(2), find_column(input, t.slice[2])))
    t[1].addHijo(t[3])
    t[1].addHijo(NodoSintactico("CORCHETEC", "]", t.lineno(4), find_column(input, t.slice[4])))
    t[0] = t[1]

def p_dimension_2(t):
    'dimension  : CORCHETEA expresion CORCHETEC'
    t[0] = NodoSintactico("DIMENSION", "DIMENSION", -1, -1)
    t[0].addHijo(NodoSintactico("CORCHETEA", "[", t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(t[2])
    t[0].addHijo(NodoSintactico("CORCHETEC", "]", t.lineno(3), find_column(input, t.slice[3])))
...
def p_construccionStruct(t):
    ...
    t[0] = NodoSintactico("CONSTRUCCIONSTRUCT", "CONSTRUCCIONSTRUCT", -1, -1)
    t[0].addHijo(NodoSintactico("IDENTIFICADOR", t[1], t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(4), find_column(input, t.slice[4])))
...
def p_listaAsignaciones_2(t):
    ...
    t[0] = NodoSintactico("LISTAASIGNACIONES", "LISTAASIGNACIONES", -1, -1)
    t[0].addHijo(t[1])

def p_aritmetica_1(t):
    'aritmetica : expresion SUMA expresion'
    t[0] = NodoSintactico("SUMA", "SUMA", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("MAS", "+", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_aritmetica_2(t):
    'aritmetica : expresion RESTA expresion'
    t[0] = NodoSintactico("RESTA", "RESTA", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("MENOS", "-", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_aritmetica_3(t):
    'aritmetica : expresion MULTIPLICACION expresion'
    t[0] = NodoSintactico("MULTIPLICACION", "MULTIPLICACION", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("ASTERISCO", "*", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_aritmetica_4(t):
    'aritmetica : expresion DIVISION expresion'
    t[0] = NodoSintactico("DIVISION", "DIVISION", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("SLASH", "/", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_aritmetica_5(t):
    'aritmetica : expresion POTENCIA expresion'
    t[0] = NodoSintactico("POTENCIA", "POTENCIA", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("ACENTO", "^", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_aritmetica_6(t):
    'aritmetica : expresion MODULO expresion'
    t[0] = NodoSintactico("MODULO", "MODULO", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("PORCENTAJE", "%", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_aritmetica_7(t):
    'aritmetica : RESTA expresion'
    t[0] = NodoSintactico("NEGATIVO", "NEGATIVO", -1, -1)
    t[0].addHijo(NodoSintactico("MENOS", "-", t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(t[2])

def p_nativa_1(t):
    'nativa : resLog10 PARENTESISA expresion PARENTESISC'
    t[0] = NodoSintactico("LOGNATURAL", "LOGNATURAL", -1, -1)
...
def p_nativa_2(t):
    ...
    t[0] = NodoSintactico("LOGBASE", "LOGBASE", -1, -1)
    t[0].addHijo(NodoSintactico("LOG", "log", t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])
    t[0].addHijo(NodoSintactico("COMA", ",", t.lineno(4), find_column(input, t.slice[4])))
    t[0].addHijo(t[5])
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(6), find_column(input, t.slice[6])))

def p_nativa_3(t):
    'nativa : resSin PARENTESISA expresion PARENTESISC'
    t[0] = NodoSintactico("SENO", "SENO", -1, -1)
...
def p_nativa_4(t):
    ...
    t[0] = NodoSintactico("COSENO", "COSENO", -1, -1)
...
def p_nativa_5(t):
    ...
    t[0] = NodoSintactico("TANGENTE", "TANGENTE", -1, -1)
...
def p_nativa_6(t):
    ...
    t[0].addHijo(NodoSintactico("SQRT", "sqrt", -1, -1))
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(4), find_column(input, t.slice[4])))
...
def p_nativa_7(t):
    ...
    t[0] = NodoSintactico("PARSEINT", "PARSEINT", -1, -1)
    t[0].addHijo(NodoSintactico("PARSE", "parse", t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(NodoSintactico("INT64", "int64", t.lineno(3), find_column(input, t.slice[3])))
    t[0].addHijo(NodoSintactico("COMA", ",", t.lineno(4), find_column(input, t.slice[4])))
    t[0].addHijo(t[5])
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(6), find_column(input, t.slice[6])))
...
def p_nativa_8(t):
    ...
    t[0] = NodoSintactico("PARSEFLOAT", "PARSEFLOAT", -1, -1)
    t[0].addHijo(NodoSintactico("PARSE", "parse", t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(NodoSintactico("FLOAT64", "float64", t.lineno(3), find_column(input, t.slice[3])))
    t[0].addHijo(NodoSintactico("COMA", ",", t.lineno(4), find_column(input, t.slice[4])))
    t[0].addHijo(t[5])
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(6), find_column(input, t.slice[6])))
...
def p_nativa_9(t):
    ...
    t[0] = NodoSintactico("TRUNCAR", "TRUNCAR", -1, -1)
...
def p_nativa_10(t):
    ...
    t[0] = NodoSintactico("CONVERTIRFLOAT", "CONVERTIRFLOAT", -1, -1)
    t[0].addHijo(NodoSintactico("FLOAT64", "float64", t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(4), find_column(input, t.slice[4])))
...
def p_nativa_11(t):
    ...
    t[0] = NodoSintactico("CONVERTIRSTRING", "CONVERTIRSTRING", -1, -1)
    t[0].addHijo(NodoSintactico("STRING", "string", t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(4), find_column(input, t.slice[4])))
...
def p_nativa_12(t):
    ...
    t[0] = NodoSintactico("OBTENERTIPO", "OBTENERTIPO", -1, -1)
...
def p_nativa_13(t):
    ...
    t[0] = NodoSintactico("HACERPOP", "HACERPOP", -1, -1)
    t[0].addHijo(NodoSintactico("POP", "pop", t.lineno(1), find_column(input, t.slice[1])))
    t[0].addHijo(NodoSintactico("PARENTESISA", "(", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(NodoSintactico("IDENTIFICADOR", t[3], t.lineno(3), find_column(input, t.slice[3])))
    t[0].addHijo(NodoSintactico("PARENTESISC", ")", t.lineno(4), find_column(input, t.slice[4])))

def p_nativa_14(t):
    'nativa : resLength PARENTESISA expresion PARENTESISC'
    t[0] = NodoSintactico("OBTENERSIZE", "OBTENERSIZE", -1, -1)
...
def p_nativa_15(t):
    ...
    t[0] = NodoSintactico("HACERUPPERCASE", "HACERUPPERCASE", -1, -1)
...
def p_nativa_16(t):
    ...
    t[0] = NodoSintactico("HACERLOWERCASE", "HACERLOWERCASE", -1, -1)
...
def p_relacionales_1(t):
    ...
    t[0] = NodoSintactico("MAYOR", "MAYOR", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("MAYORQUE", ">", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_relacionales_2(t):
    'relacionales   : expresion MENOR expresion'
    t[0] = NodoSintactico("MENOR", "MENOR", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("MENORQUE", "<", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_relacionales_3(t):
    'relacionales   : expresion MAYORIGUAL expresion'
    t[0] = NodoSintactico("MAYORIGUAL", "MAYORIGUAL", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("MAYORIGUALQUE", ">=", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_relacionales_4(t):
    'relacionales   : expresion MENORIGUAL expresion'
    t[0] = NodoSintactico("MENORIGUAL", "MENORIGUAL", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("MENORIGUALQUE", "<=", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_relacionales_5(t):
    'relacionales   : expresion IGUALIGUAL expresion'
    t[0] = NodoSintactico("IGUALDAD", "IGUALDAD", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("IGUALQUE", "==", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_relacionales_6(t):
    'relacionales   : expresion DIFERENTE expresion'
    t[0] = NodoSintactico("DIFERENCIA", "DIFERENCIA", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("DIFERENTEA", "!=", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_logicas_1(t):
    'logicas    : expresion OR expresion'
    t[0] = NodoSintactico("OR", "OR", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("BARRAS", "||", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_logicas_2(t):
    'logicas    : expresion AND expresion'
    t[0] = NodoSintactico("AND", "AND", -1, -1)
    t[0].addHijo(t[1])
    t[0].addHijo(NodoSintactico("AMPERSON", "&&", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[3])

def p_logicas_3(t):
    'logicas    : NOT expresion'
    t[0] = NodoSintactico("NOT", "NOT", -1, -1)
    t[0].addHijo(NodoSintactico("NEGACION", "!", t.lineno(2), find_column(input, t.slice[2])))
    t[0].addHijo(t[2])
...
def p_listaExpresiones_2(t):
    ...
    t[0] = NodoSintactico("LISTAEXPRESIONES", "LISTAEXPRESIONES", -1, -1)
    t[0].addHijo(t[1])
